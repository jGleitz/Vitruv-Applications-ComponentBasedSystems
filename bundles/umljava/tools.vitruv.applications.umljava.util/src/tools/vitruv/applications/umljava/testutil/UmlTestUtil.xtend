...
class UmlTestUtil {
    ...
    def static dispatch void assertUmlTypeEquals(Type type1, Type type2) {
        fail(type1 + " and " + type2 + " are not comparable or are neither Classifiers nor PrimitiveTypes nor DataTypes")
    }
    ...
    def static void assertUmlClassifierHasSuperClassifier(Classifier childClassifier, Classifier parentClassifier) {
     ...
     def static void assertUmlClassifierDontHaveSuperClassifier(Classifier childClassifier, Classifier parentClassifier) {
